...
class NetworkAnalyse:
    ...
    def drawGraph(self, attribute):
        ...
        edge_width=1, edge_color="grey", #边的宽度和颜色，建议灰色，比较好看
        vertex_label_size=0.0000000000000001,  #点标签的大小
...
if __name__ == '__main__':
    matrixfile = 'l_data.xls'
    labelfile = 'l_labels.xls'
    network = NetworkAnalyse(matrixfile, labelfile)
    print ("----result-----")
    print ("degree:"), print(network.drawGraph("degree"))
    print ("betweeness:"), print(network.drawGraph("betweeness"))
    print ("closeness:"), print(network.drawGraph("closeness"))
    print ("hub_score:"), print(network.drawGraph("hub_score"))
    print ("evcent:"), print(network.drawGraph("evcent"))
    print ("pagerank:"), print(network.drawGraph("pagerank"))
    print ("authority_score:"), print(network.drawGraph("authority_score"))
